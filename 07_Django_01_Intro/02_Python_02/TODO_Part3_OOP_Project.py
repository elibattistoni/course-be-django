...
class Deck():
    ...
    def split_in_half(self):
        """
        - the first part will have cards from index 0 to the middle of the deck (exclusive)
        - the second part will have cards from the middle of the deck (inclusive) to the end
        """
        print('Split in half')
        return (self.allcards[0:int(len(self.allcards)/2)],self.allcards[int(len(self.allcards)/2):len(self.allcards)])
