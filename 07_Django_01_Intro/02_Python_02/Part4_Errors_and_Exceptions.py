...
except IOError: ## Input Output Exception Error --> this will only look for this specific error
...
## ========================================================================== ##
#%______finally_______
## ========================================================================== ##

"""
finally: the block of code will always be run regardless if there was an
exception in the try code block. 
"""
# The syntax is:
#
#     try:
...
try:
    ...
    print('Could not find file or read or write data')
finally:
